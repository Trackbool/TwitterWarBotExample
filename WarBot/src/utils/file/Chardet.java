...
public final class Chardet {
    ...
    public static Pair<Reader, String> guessCharset(InputStream in)
        ...
        int len = in.read(buf);
        if (len <= 0) { return new Pair<>(new StringReader(""), UTF8); }
    ...
    static {
        CHARSET_BYTES = "charset".getBytes(StandardCharsets.ISO_8859_1);
        ENCODING_BYTES = "encoding".getBytes(StandardCharsets.ISO_8859_1);
    }
